...
<footer class="w-full bg-dark pt-[94px] relative">
    <img src="https://laravel-courses.com/img/footer-cure.png" alt="Stylish Design" class="w-auto h-auto object-contain absolute bottom-0 right-0 pointer-events-none z-10"/>
        <div class="max-w-[440px] sm:max-w-7xl w-full px-4 sm:px-6 lg:px-8 mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5 pb-[50px]">
            ...
            <div>
                ...
                <div>
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="mb-2">
                            <a href="{{route('archive', ['platform', 'spatie'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Spatie</a>
                        </li>
                    </ul>
                </div>
                <div>
            ...
            <!-- ::::::::::::footer bottom:::::::::::: -->
            <div class="max-w-[440px] md:max-w-7xl w-full px-4 sm:px-6 lg:px-8 mx-auto flex items-center justify-between gap-5 pb-8">
        ...
        <p class="text-base-primary text-sm text-[#E5E5E580] leading-5 z-50 relative">
            Developed by <a href="/" target="_blank" class="hover:underline font-medium">Mohammad Ejmul ⚡️</a>
        </p>
        <span></span>
    </div>
</footer>
